...
public class BytebankApplication {
    ...
    private static int exibirMenu() {
        System.out.println("""
                ...
                7 - Realizar Tranferência entre duas contas
                8 - Sair
                """);
    ...
    private static void realizarTranferencia() {
        System.out.println("Digite o número da conta do pagador:");
        var pagador = teclado.nextInt();

        System.out.println("Digite o número da conta beneficiado:");
        var beneficiado = teclado.nextInt();
